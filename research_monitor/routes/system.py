...
def get_current_summary(db):
    ...
    from research_monitor import app_v2
    from research_monitor.models import TimelineEvent, EventMetadata, ResearchPriority
    from research_monitor.qa_queue import QAQueueManager
...
def get_session_status():
    ...
    from research_monitor import app_v2
    from research_monitor.models import ResearchSession, ResearchPriority, EventMetadata
