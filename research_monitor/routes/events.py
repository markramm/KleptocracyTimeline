...
def batch_create_events():
    ...
    from research_monitor.models import EventMetadata, ResearchSession, ActivityLog
    from research_monitor import app_v2
...
def trigger_commit():
    ...
    from research_monitor.models import ResearchPriority, ResearchSession
    from research_monitor import app_v2
